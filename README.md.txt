# Employee project
In this project we'll use the data in the link https://www.kaggle.com/datasets/tawfikelmetwally/employee-dataset
...
3. s there a correlation between Payment Tier and Experience in Current Domain?
